...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>La Oficina, San Juanico</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0 user-scalable=no">
    <meta name="description" content="">
    <meta name="author" content="anam shaz skip">
    ...
    <link href='http://fonts.googleapis.com/css?family=Muli|Pinyon+Script' rel='stylesheet' type='text/css'>
  ...
  <body>
    ...
    <div class="my-nav-wrapper">
   	...
   	<div class="lao-logo">
    		<img src="img/oficina-ellipse-logo.png">
